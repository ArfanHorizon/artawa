    ...
    return (
        <section id="home" className="relative h-screen flex items-center justify-center bg-cover bg-fixed" style={{backgroundImage: "url('https://placehold.co/1920x1080/1a1a1a/ffffff?text=PT+Artawa+Indonesia')"}}>
            ...
            <div className="relative z-10 text-center text-white px-6 max-w-4xl mx-auto">
                <AnimatedSection>
                    <img src={process.env.PUBLIC_URL + '/logoartawa.png'} alt="Logo Artawa" className="h-24 mx-auto mb-6"/>
                    <h1 className="text-4xl md:text-7xl font-extrabold mb-4 leading-tight drop-shadow-2xl"></h1>
